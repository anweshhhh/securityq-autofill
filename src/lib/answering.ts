...
export type QuestionCategory = "GENERAL";
...
export function categorizeQuestion(_question: string): QuestionCategory {
  return "GENERAL";
}

export function chunkMatchesCategoryMustMatch(_category: QuestionCategory, _chunkText: string): boolean {
  return true;
}
